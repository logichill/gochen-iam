...
func (r *GroupRepo) FindByUserID(ctx context.Context, userID int64) ([]*iamentity.Group, error) {
	...
	if err != nil {
		return nil, errors.WrapError(err, errors.ErrCodeDatabase, "查询用户组织失败")
	}
...
func (r *GroupRepo) FindChildren(ctx context.Context, parentID int64) ([]*iamentity.Group, error) {
	...
	if err != nil {
		return nil, errors.WrapError(err, errors.ErrCodeDatabase, "查询子组织失败")
	}
...
func (r *GroupRepo) FindRootGroups(ctx context.Context) ([]*iamentity.Group, error) {
	...
	if err != nil {
		return nil, errors.WrapError(err, errors.ErrCodeDatabase, "查询根组织失败")
	}
...
func (r *GroupRepo) FindByLevel(ctx context.Context, level int) ([]*iamentity.Group, error) {
	...
	if err != nil {
		return nil, errors.WrapError(err, errors.ErrCodeDatabase, "查询组织失败")
	}
...
func (r *GroupRepo) FindByPath(ctx context.Context, path string) (*iamentity.Group, error) {
	...
	if err != nil {
		if stdErrors.Is(err, orm.ErrNotFound) {
			return nil, errors.NewError(errors.ErrCodeNotFound, "组织不存在")
		}
		return nil, errors.WrapError(err, errors.ErrCodeDatabase, "查询组织失败")
	}
...
func (r *GroupRepo) AddUserToGroup(ctx context.Context, groupID, userID int64) error {
	...
	if err != nil {
		return errors.WrapError(err, errors.ErrCodeDatabase, "添加用户到组织失败")
	}
...
func (r *GroupRepo) RemoveUserFromGroup(ctx context.Context, groupID, userID int64) error {
	...
	if err != nil {
		return errors.WrapError(err, errors.ErrCodeDatabase, "从组织移除用户失败")
	}
...
func (r *GroupRepo) AddDefaultRole(ctx context.Context, groupID, roleID int64) error {
	...
	err = r.Association(group, "DefaultRoles").
		Append(ctx, &iamentity.Role{EntityFields: sharedentity.EntityFields{ID: roleID}})

	if err != nil {
		return errors.WrapError(err, errors.ErrCodeDatabase, "添加默认角色失败")
	}
...
func (r *GroupRepo) RemoveDefaultRole(ctx context.Context, groupID, roleID int64) error {
	...
	err = r.Association(group, "DefaultRoles").
		Delete(ctx, &iamentity.Role{EntityFields: sharedentity.EntityFields{ID: roleID}})

	if err != nil {
		return errors.WrapError(err, errors.ErrCodeDatabase, "移除默认角色失败")
	}
...
func (r *GroupRepo) GetGroupTree(ctx context.Context) ([]*iamentity.Group, error) {
	...
	if err != nil {
		return nil, errors.WrapError(err, errors.ErrCodeDatabase, "查询组织树失败")
	}
...
func (r *GroupRepo) CountByLevel(ctx context.Context) (map[int]int64, error) {
	...
	if err != nil {
		return nil, errors.WrapError(err, errors.ErrCodeDatabase, "统计组织层级失败")
	}
...
func (r *GroupRepo) SearchGroups(ctx context.Context, keyword string, limit int) ([]*iamentity.Group, error) {
	...
	if err != nil {
		return nil, errors.WrapError(err, errors.ErrCodeDatabase, "搜索组织失败")
	}
...
func (r *GroupRepo) FindByDefaultRoleID(ctx context.Context, roleID int64) ([]*iamentity.Group, error) {
	...
	if err != nil {
		return nil, errors.WrapError(err, errors.ErrCodeDatabase, "查询使用指定默认角色的组织失败")
	}
